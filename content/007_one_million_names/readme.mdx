...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./01.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./02.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./03.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./04.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./05.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./06.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./07.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./08.webp")) }
...
{ (async (x) => {return <img src={(await x)?.default?.src}/>})(import("./09.webp")) }
