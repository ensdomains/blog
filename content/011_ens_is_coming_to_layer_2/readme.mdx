...
*It's important to note that the registry we'll have deployed in Phase 2 won't be used in Phase 3 as we wont have way for a name to be on L1, and also be claimable on L2 until Phase 4 is complete.* *
