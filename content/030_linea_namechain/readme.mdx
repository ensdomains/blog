...
The selection of Linea as the foundation for Namechain emerged from a comprehensive technical and strategic evaluation conducted by the ENS Labs team, which you can read about [here](https://blog.ens.domains/post/ensv2-update). Two key architectural decisions immediately stood out:
